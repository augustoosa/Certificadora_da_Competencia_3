  ...
  return (
    <div className="w-full">
      ...
      <div className="space-y-4 mb-10">
        ...
        {/* Card de Evento 1 */}
        <div className="bg-white border border-gray-100 rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow flex flex-col xl:flex-row gap-6 justify-between items-start xl:items-center">
          ...
          <div className="flex items-center gap-2 w-full xl:w-auto justify-end border-t xl:border-t-0 pt-4 xl:pt-0">
            <button className="p-2.5 text-gray-400 hover:text-gray-700 hover:bg-gray-100 rounded-xl transition-colors" title="Abrir página do evento"><ExternalLink size={20}/></button>
            <button className="p-2.5 text-gray-400 hover:text-fuchsia-600 hover:bg-fuchsia-50 rounded-xl transition-colors" title="Editar"><Edit2 size={20}/></button>
            <button className="p-2.5 text-gray-400 hover:text-red-600 hover:bg-red-50 rounded-xl transition-colors" title="Excluir"><Trash2 size={20}/></button>
          </div>
        </div>
      ...
      <div className="bg-white border border-gray-200 rounded-2xl p-5 shadow-sm flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 opacity-60 grayscale-[30%]">
        ...
        <button className="p-2 text-gray-400 hover:text-red-600 hover:bg-red-50 rounded-xl transition-colors self-end sm:self-auto" title="Excluir">
          <Trash2 size={20}/>
        </button>
      </div>
    </div>
